    ...
    Student(String name,int rollno){
        ...
        public static void main(String[] args) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                System.out.println("Year I Marks  : "+ y1[i].sub1Marks+((y1[i].sub1Marks > 50) ? "-Pass" : "-Fail")+"  "+ y1[i].sub2Marks+((y1[i].sub2Marks > 50) ? "-Pass" : "-Fail"));
                System.out.println("Year II Marks : " +y2[i].sub3Marks+ ((y2[i].sub3Marks > 50) ? "-Pass" : "-Fail")+"  "+ y2[i].sub4Marks+ ((y2[i].sub4Marks > 50) ? "-Pass" : "-Fail"));
            }
        }
}
